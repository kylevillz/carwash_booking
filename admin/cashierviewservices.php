...
if ($_SESSION['useremail']=="" OR $_SESSION['role']=="customer" OR $_SESSION['role']=="Admin" OR $_SESSION['role']=="Manager" OR $_SESSION['role']=="user") {
      ...
      <!--------------------------
        ...
        <div class="box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title"><a href="cashierservicelist.php" class="btn btn-primary" role="button">Back to Service list</a></h3>
          </div>
            ...
            <div class="box-body">
              ...
              while($row=$select->fetch(PDO::FETCH_OBJ)){
                ...
                <ul class="list-group">
                 ...
                 <li class="list-group-item"><b>Employee Assigned</b><span class="label label-warning pull-right">'.$row->employee.'</span></li>
