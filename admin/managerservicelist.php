              ...
              <table id = "tableservice" class = "table table-striped"  >
                ...
                <tbody>
                  ...
                  while($row=$select->fetch(PDO::FETCH_OBJ)){
                    ...
                    <td>
                    <a href = "managerviewservices.php?id='.$row->sid.'"  class="btn btn-success" role = "button" ><span class = "glyphicon glyphicon-eye-open" style = "color:#ffffff" data-toggle="tooltip" title="view"></span></a>
                    </td>
