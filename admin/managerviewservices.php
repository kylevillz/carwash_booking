...
if ($_SESSION['useremail']=="" OR $_SESSION['role']=="customer" OR $_SESSION['role']=="Admin" OR $_SESSION['role']=="user" OR $_SESSION['role']=="cashier") {
      ...
      <!--------------------------
        ...
        <div class="box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title"><a href="managerservicelist.php" class="btn btn-primary" role="button">Back to Service list</a></h3>
          </div>
