      ...
      <!--------------------------
        ...
        <div class="box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title"><a href="addservices.php" class="btn btn-primary" role="button">Add service</a></h3>
          </div>
              ...
              <table id = "tableservice" class = "table table-striped"  >
                ...
                <tbody>
                  ...
                  while($row=$select->fetch(PDO::FETCH_OBJ)){
                    ...
                    <td>
                    <a href = "editservice.php?id='.$row->sid.'"  class="btn btn-info" role = "button" ><span class = "glyphicon glyphicon-edit" style = "color:#ffffff" data-toggle="tooltip" title="edit"></span></a>
                    </td>
