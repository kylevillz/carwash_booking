...
if(isset($_POST['btnaddemployee'])){
  ...
  $dob = $_POST['txtdob'];
  $blood_type = $_POST['txtblood_type'];
  $role = $_POST['txtrole'];
            ...
            <div class="box-body">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="txtblood_type">
                    <option value="" disabled selected>Select blood type</option required>
                      <?php
                      $select=$pdo->prepare("select * from tbl_blood_type");
                      $select->execute();
