...
if ($row) {
  if($row['useremail']==$useremail AND $row['password']==$password AND $row['role']=='cashier' ){
  ...
  jQuery(function validation(){
    ...
    header('refresh:3;cashier.php');
}


}
if ($row) {
  if($row['useremail']==$useremail AND $row['password']==$password AND $row['role']=='Manager' ){
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>CARWASH</b>BOOKING</a>
  </div>
  <!-- /.login-logo -->
