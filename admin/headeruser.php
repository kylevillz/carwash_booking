  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="userreservationlist.php"><i class="fa fa-book"></i> <span>Reservation List</span></a></li>
        <li><a href="userservicelist.php"><i class="fa fa-car"></i> <span>Service List</span></a></li>
