      ...
      <!--------------------------
        ...
        <div class="box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title"><a href="cashierreservationlist.php" class="btn btn-primary" role="button">Back to Reservation list</a></h3>
          </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="txtuser">
                          <option value="" disabled selected>Select user</option required>
                            <?php
                            ...
                            while($row=$select->fetch(PDO::FETCH_ASSOC)){
                             ...
                             ?>
                          <option <?php if($row['username']==$user_db) {?>
