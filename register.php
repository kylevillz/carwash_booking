...
if(isset($_POST['btnsave'])){
  ...
  if(!isset($username) || trim($username) == ''){
    ...
    if($select->rowCount() > 0){
      ...
      $insert=$pdo->prepare("insert into tbl_customer(username,useremail,password)values(:name,:email,:pass)");
  ...
  <div class="register-box-body">
    ...
    <form action="" method="post" role="form">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" name="btnsave" class="btn btn-primary btn-block btn-flat">Register</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
